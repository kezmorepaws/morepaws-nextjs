...
export const FormSectionStack = styled(Stack)(({ sx, theme, singleItem, matchGapMB, fullWidthMobile }) => ({
  gap: theme.spacing(3),
  flexDirection: 'row',
  ...
  [theme.breakpoints.down('md')]: {
    gap: theme.spacing(2),
    width:
      singleItem & fullWidthMobile ? '100%' : singleItem && !fullWidthMobile ? `calc(50% - ${theme.spacing(1)})` : '',
